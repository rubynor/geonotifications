  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved poi as @poi" do
        ...
        post :create, {:poi => { "location" => "invalid value" }}, valid_session
        assigns(:poi).should be_a_new(Poi)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested poi" do
        ...
        Poi.any_instance.should_receive(:update).with({ "location" => "" })
        put :update, {:id => poi.to_param, :poi => { "location" => "" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the poi as @poi" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Poi.any_instance.stub(:save).and_return(false)
        put :update, {:id => poi.to_param, :poi => { "location" => "invalid value" }}, valid_session
        assigns(:poi).should eq(poi)
      end
